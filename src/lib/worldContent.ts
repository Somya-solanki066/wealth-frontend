...
export const WORLD_PAGES: Record<ActiveWorld, WorldPageData> = {
  ...
  student: {
    ...
    features: [
      { icon: "📚", title: "JAMB UTME Practice", desc: "25 years of past questions across all 14 JAMB subjects. CBT interface that mirrors the real JAMB exam exactly — timer, mark for review, auto-submit. Post-UTME per university.", tag: "MORE FREE THAN PAID", link: "/dashboard?tab=student&tool=jamb-practice" },
      { icon: "🏫", title: "University Past Questions", desc: "20 universities. All faculties — Sciences, Engineering, Law, Medicine, Arts, Commerce, Education. Navigate by University → Faculty → Department → Course → Year.", tag: "3 YEARS FREE", link: "/dashboard?tab=student&tool=university-past" },
      { icon: "💊", title: "Nursing Hub", desc: "Year 1 through Year 5. MedSurg, MCH, Community Health, Mental Health, ICU, Emergency Nursing. Drug Calculation Tool built in — unique in Nigeria.", tag: "FREE + PREMIUM", link: "/dashboard?tab=student&tool=nursing-hub" },
      { icon: "🩺", title: "MBBS Hub", desc: "Complete 6-year programme. Pre-clinical, Para-clinical, Clinical years. Clinical scenario questions that mirror real professional exams. Not just MCQs.", tag: "FREE + PREMIUM", link: "/dashboard?tab=student&tool=mbbs-hub" },
      { icon: "⚖️", title: "All Professional Courses", desc: "Law, Pharmacy, Medical Lab Science, Radiography, Physiotherapy, Dentistry, Optometry, Nutrition, Public Health, Environmental Health. All covered.", tag: "FREE + PREMIUM", link: "/dashboard?tab=student&tool=professional-courses" },
      { icon: "📊", title: "Smart Performance Analytics", desc: "Score history. Subject breakdown. Weak area detector. Study streak. The app tells you exactly what to study today based on where you are weakest.", tag: "FREE", link: "/dashboard?tab=student&tool=performance-analytics" },
      { icon: "🗓️", title: "Study Planner", desc: "AI generates a personalized day-by-day study schedule based on your subject and exam date.", tag: "FREE", link: "/dashboard?tab=student&tool=study-planner" },
      { icon: "🃏", title: "Active Recall Flashcards", desc: "Paste your notes and AI generates smart question-and-answer flashcards for active recall.", tag: "FREE", link: "/dashboard?tab=student&tool=flashcards" },
      { icon: "📄", title: "Citation Generator", desc: "APA, MLA, Harvard, Chicago, Vancouver. Books, articles, websites, YouTube videos — all covered.", tag: "FREE", link: "/dashboard?tab=student&tool=citation" },
      { icon: "▶️", title: "Course Video Finder", desc: "Enter any topic and AI finds the best YouTube tutorials to help you master it fast.", tag: "FREE", link: "/dashboard?tab=student&tool=video-finder" },
      { icon: "✍️", title: "Essay & Project Writer", desc: "AI writes essays, research papers, dissertations, lab reports, and case studies to your word count.", tag: "PREMIUM", link: "/dashboard?tab=student&tool=essay-writer" },
      { icon: "🧠", title: "Exam Techniques Hub", desc: "Active Recall, Spaced Repetition, Pomodoro, Mind Mapping, Memory Palace, Feynman Technique.", tag: "FREE", link: "/dashboard?tab=student&tool=exam-techniques" },
    ],
    pricing: [
      {
    ...
    courses: [
      { icon: "📚", title: "JAMB UTME Prep", desc: "25 years of past questions with CBT mode that mirrors the real exam.", meta: "14 subjects", href: "/dashboard?tab=student&tool=jamb-practice" },
      { icon: "🏫", title: "University Past Questions", desc: "20 universities across all faculties — Sciences, Law, Medicine, Engineering and more.", meta: "Faculty → Course → Year", href: "/dashboard?tab=student&tool=university-past" },
