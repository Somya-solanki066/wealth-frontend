...
export default function FeaturesPage() {
  ...
  const features = [
    {
      icon: <Search className="h-9 w-9 text-[#C9A84C]" />,
    ...
    {
      icon: <CheckCircle className="h-9 w-9 text-[#C9A84C]" />,
    ...
    {
      icon: <BookOpen className="h-9 w-9 text-[#C9A84C]" />,
    ...
    {
      icon: <Clapperboard className="h-9 w-9 text-[#C9A84C]" />,
    ...
    {
      icon: <GraduationCap className="h-9 w-9 text-[#C9A84C]" />,
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 space-y-16">
          ...
          <div className="text-center space-y-4 max-w-3xl mx-auto">
            ...
            <h1 className="font-serif text-4xl md:text-5xl font-black text-white">
              {content.heroTitleBlack || "Built for"} <span className="text-[#C9A84C]">{content.heroTitleGold || "Serious Writers"}</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feat, idx) => {
              const CardContent = (
                <div
                  className="bg-[#161616] border border-[#242424] hover:border-[#7A5E1E] rounded-3xl p-8 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden group shadow-lg h-full cursor-pointer"
                >
                ...
                return (
                  <button
                    ...
                    className={`px-5 py-2.5 rounded-xl border text-xs font-semibold transition-all duration-200 ${
                      isActive
                        ? "bg-[#C9A84C]/12 border-[#7A5E1E] text-[#C9A84C]"
