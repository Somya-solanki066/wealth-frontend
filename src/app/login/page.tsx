...
import { KeyRound, Mail, Eye, EyeOff, BookOpen } from "lucide-react";
      ...
      <Card hoverable={false} className="relative z-10 w-full max-w-md space-y-8 bg-[#0f0f0f] border border-[#242424] p-8 rounded-2xl shadow-2xl">
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="block text-[10px] font-bold uppercase tracking-wider text-[#909090]">
                  Password
                </label>
                <Link
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-[10px] uppercase">
            <span className="bg-[#0f0f0f] px-2 text-[#606060]">Or connect with</span>
          </div>
        </div>
