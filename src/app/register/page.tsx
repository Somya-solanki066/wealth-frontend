  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#080808] px-4 py-12">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[20%] right-[20%] h-96 w-96 rounded-full bg-[#C9A84C]/5 blur-[100px]" />
        <div className="absolute bottom-[20%] left-[20%] h-96 w-96 rounded-full bg-[#7A5E1E]/5 blur-[100px]" />
      </div>
